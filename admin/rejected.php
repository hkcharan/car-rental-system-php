...
include 'header.php';
    ...
    $sql = "SELECT * FROM bookings WHERE status='rejected'";
$result = mysqli_query($conn,$sql);
    ?>
   
   <div class="container">
    <div class="path">Manage Bookings > <a href="rejected.php"><span>Rejected Bookings</span></a></div>
    <div class="brand_container">
      <table class="content-table">
        ...
        <td>$brand_name</td>  
          <td>$fromdate</td>
          <td>$todate</td>
          <td><p class='rejected'>$status</p></td>
        </tr>";
            }
            ?>
